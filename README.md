# BGL Gamebient Engine

The BGL (Gamebient) Engine is a Solana-based gaming ecosystem that combines NFT-based virtual arcade machines with a staking incentive layer.

## Programs

This project contains the following programs:

- [BGL Cartridge](./programs/bgl-cartridge/README.md) - NFT gaming platform for machines, games, and cartridges
