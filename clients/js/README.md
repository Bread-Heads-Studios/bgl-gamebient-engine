# JavaScript client for Bgl Cartridge
...
2. Next, install this library using the package manager of your choice.
   ```sh
   npm install @metaplex-foundation/bgl-cartridge
   ```
2. Finally, register the library with your Umi instance like so.
   ```ts
   import { bglCartridge } from '@metaplex-foundation/bgl-cartridge';
   umi.use(bglCartridge());
   ```

You can learn more about this library's API by reading its generated [TypeDoc documentation](https://bgl-cartridge-js-docs.vercel.app).
