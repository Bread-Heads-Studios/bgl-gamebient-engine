...
// Accounts.
export type InsertCartridgeV1InstructionAccounts = {
...
export function getInsertCartridgeV1InstructionDataSerializer(): Serializer<
  ...
  InsertCartridgeV1InstructionData
> {
...
export function insertCartridgeV1(
  ...
  input: InsertCartridgeV1InstructionAccounts & InsertCartridgeV1InstructionArgs
): TransactionBuilder {
  // Program ID.
  ...
  // Arguments.
  const resolvedArgs: InsertCartridgeV1InstructionArgs = { ...input };
  ...
  // Data.
  const data = getInsertCartridgeV1InstructionDataSerializer().serialize(
    resolvedArgs as InsertCartridgeV1InstructionDataArgs
  );
