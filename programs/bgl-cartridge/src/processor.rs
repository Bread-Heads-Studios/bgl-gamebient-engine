...
use crate::error::BglCartridgeError;
use crate::instruction::accounts::CreateAccounts;
use crate::instruction::{BglCartridgeInstruction, CreateArgs};
...
pub fn process_instruction<'a>(
    ...
    let instruction: BglCartridgeInstruction =
        BglCartridgeInstruction::try_from_slice(instruction_data)?;
    match instruction {
        BglCartridgeInstruction::Create(args) => {
